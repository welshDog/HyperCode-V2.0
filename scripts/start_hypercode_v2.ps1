...
# 2. Cleanup Phase (The "Janitor" Logic)
Write-Log "2. Cleaning up Zombie Containers..." "Yellow"
...
# 3. Build & Start Sequence
Write-Log "3. Building and Starting Services..." "Yellow"
...
# 4. Health Check Loop (The "Healer" Logic)
Write-Log "4. Waiting for System Health (Timeout: 60s)..." "Yellow"
...
# 5. Network & Volume Verification
Write-Log "5. Verifying Network & Volumes..." "Yellow"
