...
[![Version](https://img.shields.io/badge/version-2.0.0-blue)](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/core/config.py#L4-L20)
[![License: AGPL v3](https://img.shields.io/badge/License-AGPL_v3-blue.svg)](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/LICENSE)
[![Contributions Welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg)](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/CONTRIBUTING.md)
...
Aligned with [Goal for the agents.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/docs/notes/Goal%20for%20the%20agents.md), the default configuration now favors smaller models and predictable output structure.
...
- Backend model auto-selection: [ollama.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/llm/ollama.py)
- Backend request routing + prompt shaping: [brain.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/agents/brain.py)
- Configurable tuning surface: [config.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/core/config.py#L21-L51)

### 2) Configuration + docs alignment across environments

- Docker Compose environment defaults updated to match TinyLlama-first behavior: [docker-compose.yml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/docker-compose.yml)
- K8s config updated to reflect new defaults: [02-configmap.yaml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/k8s/02-configmap.yaml) and [10-ollama.yaml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/k8s/10-ollama.yaml)
- Agent config defaults standardized: example [agents/01-frontend-specialist/config.json](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/agents/01-frontend-specialist/config.json)

### 3) Reproducible tests for selection + tuning

- Unit tests verify selection ordering, size filtering, and caching: [test_ollama_model_selection.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/tests/unit/test_ollama_model_selection.py)
- Optional integration test defines a measurable behavior improvement metric (repetition score): [test_ollama_tuning.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/tests/integration/test_ollama_tuning.py)
...
Primary docs:
- Platform overview: [ARCHITECTURE.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/ARCHITECTURE.md)
- Kubernetes guide: [DEPLOYMENT_GUIDE.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/DEPLOYMENT_GUIDE.md)
...
References:
- Selector + resolver: [ollama.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/llm/ollama.py)
- Brain integration: [brain.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/agents/brain.py)
...
- [ollama_generate_options](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/core/config.py#L39-L50)
...
Reference: [brain.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/agents/brain.py)
...
- [scripts/ollama_benchmark.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/scripts/ollama_benchmark.py)
...
- [test_ollama_tuning.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/tests/integration/test_ollama_tuning.py)
...
Coverage:
- **Total**: **69%**
- LLM auto-selection module: **85%** ([app/llm/ollama.py](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/backend/app/llm/ollama.py))
...
CI entry point:
- [ci.yml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/.github/workflows/ci.yml)
...
More details:
- [CONTRIBUTING.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/CONTRIBUTING.md)
- [TROUBLESHOOTING.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/TROUBLESHOOTING.md)

### Kubernetes (cluster deployment)

Primary guide:
- [DEPLOYMENT_GUIDE.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/DEPLOYMENT_GUIDE.md)

Key manifests:
- App ConfigMap: [k8s/02-configmap.yaml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/k8s/02-configmap.yaml)
- Ollama StatefulSet: [k8s/10-ollama.yaml](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/k8s/10-ollama.yaml)
...
- Guidelines: [CONTRIBUTING.md](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/CONTRIBUTING.md)
- Recommended commit style: Conventional Commits (`feat:`, `fix:`, etc.)

### Security & safety

- License: AGPL-3.0 ([LICENSE](file:///H:/HyperStation%20zone/HyperCode/HyperCode-V2.0/LICENSE))
