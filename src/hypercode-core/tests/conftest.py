...
# Ensure critical env vars are set BEFORE imports to prevent Pydantic validation errors during collection
os.environ.setdefault("HYPERCODE_DB_URL", "sqlite://")
os.environ.setdefault("HYPERCODE_REDIS_URL", "redis://localhost:6379/0")
os.environ.setdefault("API_KEY", "test-api-key")
os.environ.setdefault("HYPERCODE_JWT_SECRET", "test-jwt-secret-at-least-32-chars-long")
