...
@patch("app.worker.asyncio.run", return_value="Agent plan output here")
...
@patch("app.worker.SessionLocal")
@patch("app.worker.asyncio.run", return_value="some output")
...
@patch("app.worker.asyncio.run", side_effect=RuntimeError("router exploded"))
...
@patch("app.worker.SessionLocal")
@patch("app.worker.asyncio.run", return_value="plan")
@patch("app.worker.os.path.exists", return_value=True)
@patch("builtins.open", mock_open())
